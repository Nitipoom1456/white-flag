...
type FeatureFlagSetting struct {
	...
	MinAppVersionID *uuid.UUID `gorm:"column:min_app_version_id;type:uuid;null" json:"min_app_version_id"`
	MaxAppVersionID *uuid.UUID `gorm:"column:max_app_version_id;type:uuid;null" json:"max_app_version_id"`
